namespace YuGiOhTracker
{
	partial class frmMain
	{
		...
		private void InitializeComponent()
		{
			...
			this.gbUserDeckList = new System.Windows.Forms.GroupBox();
			this.btnSearchUser = new System.Windows.Forms.Button();
			this.lblSearchInUser = new System.Windows.Forms.Label();
			this.cbSearchInUser = new System.Windows.Forms.ComboBox();
			this.txtSearchUser = new System.Windows.Forms.TextBox();
			this.lblSearchUser = new System.Windows.Forms.Label();
			this.dgvUserDecks = new System.Windows.Forms.DataGridView();
			...
			this.tpUserDecks.SuspendLayout();
			this.gbUserDeckList.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.dgvUserDecks)).BeginInit();
			...
			// tpUserDecks
			// 
			this.tpUserDecks.Controls.Add(this.gbUserDeckList);
			...
			// gbUserDeckList
			// 
			this.gbUserDeckList.Controls.Add(this.btnSearchUser);
			this.gbUserDeckList.Controls.Add(this.lblSearchInUser);
			this.gbUserDeckList.Controls.Add(this.cbSearchInUser);
			this.gbUserDeckList.Controls.Add(this.txtSearchUser);
			this.gbUserDeckList.Controls.Add(this.lblSearchUser);
			this.gbUserDeckList.Controls.Add(this.dgvUserDecks);
			this.gbUserDeckList.Location = new System.Drawing.Point(8, 3);
			this.gbUserDeckList.Name = "gbUserDeckList";
			this.gbUserDeckList.Size = new System.Drawing.Size(899, 399);
			this.gbUserDeckList.TabIndex = 5;
			this.gbUserDeckList.TabStop = false;
			this.gbUserDeckList.Text = "User Deck List";
			// 
			// btnSearchUser
			// 
			this.btnSearchUser.Location = new System.Drawing.Point(768, 17);
			this.btnSearchUser.Name = "btnSearchUser";
			this.btnSearchUser.Size = new System.Drawing.Size(125, 23);
			...
			// lblSearchInUser
			// 
			this.lblSearchInUser.AutoSize = true;
			this.lblSearchInUser.Location = new System.Drawing.Point(577, 22);
			this.lblSearchInUser.Name = "lblSearchInUser";
			this.lblSearchInUser.Size = new System.Drawing.Size(19, 13);
			this.lblSearchInUser.TabIndex = 5;
			this.lblSearchInUser.Text = "In:";
			// 
			// cbSearchInUser
			// 
			this.cbSearchInUser.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.cbSearchInUser.FormattingEnabled = true;
			this.cbSearchInUser.Location = new System.Drawing.Point(602, 19);
			this.cbSearchInUser.Name = "cbSearchInUser";
			this.cbSearchInUser.Size = new System.Drawing.Size(160, 21);
			this.cbSearchInUser.TabIndex = 3;
			// 
			// txtSearchUser
			// 
			this.txtSearchUser.Location = new System.Drawing.Point(71, 19);
			this.txtSearchUser.Name = "txtSearchUser";
			this.txtSearchUser.Size = new System.Drawing.Size(500, 20);
			...
			this.lblSearchUser.Location = new System.Drawing.Point(6, 22);
			this.lblSearchUser.Name = "lblSearchUser";
			this.lblSearchUser.Size = new System.Drawing.Size(59, 13);
			this.lblSearchUser.TabIndex = 2;
			this.lblSearchUser.Text = "Search for:";
			// 
			// dgvUserDecks
			// 
			this.dgvUserDecks.AllowUserToAddRows = false;
			this.dgvUserDecks.AllowUserToDeleteRows = false;
			this.dgvUserDecks.AllowUserToResizeRows = false;
			this.dgvUserDecks.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.dgvUserDecks.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.dgvUserDecks.Location = new System.Drawing.Point(6, 46);
			this.dgvUserDecks.MultiSelect = false;
			this.dgvUserDecks.Name = "dgvUserDecks";
			this.dgvUserDecks.ReadOnly = true;
			this.dgvUserDecks.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
			this.dgvUserDecks.Size = new System.Drawing.Size(887, 347);
			this.dgvUserDecks.TabIndex = 1;
			this.dgvUserDecks.CellDoubleClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.dgvUserDecks_CellDoubleClick);
			this.dgvUserDecks.CellMouseClick += new System.Windows.Forms.DataGridViewCellMouseEventHandler(this.dgvUserDecks_CellMouseClick);
			this.dgvUserDecks.KeyDown += new System.Windows.Forms.KeyEventHandler(this.dgvUserDecks_KeyDown);
			this.dgvUserDecks.MouseClick += new System.Windows.Forms.MouseEventHandler(this.dgvUserDecks_MouseClick);
			// 
			// tpLimitedCards
			// 
			...
			this.tpUserDecks.ResumeLayout(false);
			this.gbUserDeckList.ResumeLayout(false);
			this.gbUserDeckList.PerformLayout();
			((System.ComponentModel.ISupportInitialize)(this.dgvUserDecks)).EndInit();
		...
		private System.Windows.Forms.GroupBox gbUserDeckList;
		private System.Windows.Forms.Button btnSearchUser;
		private System.Windows.Forms.Label lblSearchInUser;
		private System.Windows.Forms.ComboBox cbSearchInUser;
		private System.Windows.Forms.TextBox txtSearchUser;
		private System.Windows.Forms.Label lblSearchUser;
		private System.Windows.Forms.DataGridView dgvUserDecks;
	}
}
